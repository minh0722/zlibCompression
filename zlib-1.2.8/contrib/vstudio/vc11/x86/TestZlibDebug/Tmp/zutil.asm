; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24210.0 
	...
	TITLE	F:\playground\assassin-playground\ctsvetkov\minh_nguyen\zlibCompression\zlib-1.2.8\zutil.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG89310 DB	'need dictionary', 00H
$SG89311 DB	'stream end', 00H
	ORG $+1
$SG89313 DB	'file error', 00H
	ORG $+1
$SG89314 DB	'stream error', 00H
	ORG $+3
$SG89315 DB	'data error', 00H
	ORG $+1
$SG89316 DB	'insufficient memory', 00H
$SG89317 DB	'buffer error', 00H
	ORG $+3
$SG89318 DB	'incompatible version', 00H
	ORG $+3
$SG89321 DB	'1.2.8', 00H
_DATA	ENDS
...
; File f:\playground\assassin-playground\ctsvetkov\minh_nguyen\zlibcompression\zlib-1.2.8\zutil.c
_TEXT	SEGMENT
_opaque$ = 8						; size = 4
_ptr$ = 12						; size = 4
_zcfree	PROC
