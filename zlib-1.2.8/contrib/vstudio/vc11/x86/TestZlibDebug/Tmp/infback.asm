; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24210.0 
	...
	TITLE	F:\playground\assassin-playground\ctsvetkov\minh_nguyen\zlibCompression\zlib-1.2.8\infback.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG86190 DB	'invalid block type', 00H
	ORG $+1
$SG86195 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG86207 DB	'too many length or distance symbols', 00H
$SG86211 DB	'invalid code lengths set', 00H
	ORG $+3
$SG86222 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG86230 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG86233 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG86235 DB	'invalid literal/lengths set', 00H
$SG86237 DB	'invalid distances set', 00H
	ORG $+2
$SG86253 DB	'invalid literal/length code', 00H
$SG86265 DB	'invalid distance code', 00H
	ORG $+2
$SG86270 DB	'invalid distance too far back', 00H
	ORG $+2
$SG85804 DB	'1.2.8', 00H
_DATA	ENDS
...
; File f:\playground\assassin-playground\ctsvetkov\minh_nguyen\zlibcompression\zlib-1.2.8\infback.c
_TEXT	SEGMENT
_state$ = 8						; size = 4
_fixedtables PROC
...
; 37   :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG85804[edx]
	cmp	eax, ecx
...
; 320  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86190
...
; 331  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86195
...
; 369  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86207
...
; 383  :             while (state->have < 19)
	...
	mov	edx, DWORD PTR _state$[ebp]
	cmp	DWORD PTR [edx+104], 19			; 00000013H
...
; 391  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86211
...
; 414  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86222
...
; 437  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86230
...
; 451  :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86233
...
; 465  :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86235
...
; 474  :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86237
...
; 532  :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86253
...
; 564  :                 strm->msg = (char *)"invalid distance code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86265
...
; 579  :                 strm->msg = (char *)"invalid distance too far back";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86270
