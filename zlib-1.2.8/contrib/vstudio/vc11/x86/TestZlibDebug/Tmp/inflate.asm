; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24210.0 
	...
	TITLE	F:\playground\assassin-playground\ctsvetkov\minh_nguyen\zlibCompression\zlib-1.2.8\inflate.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG86406 DB	'incorrect header check', 00H
	ORG $+1
$SG86408 DB	'unknown compression method', 00H
	ORG $+1
$SG86412 DB	'invalid window size', 00H
$SG86416 DB	'unknown compression method', 00H
	ORG $+1
$SG86418 DB	'unknown header flags set', 00H
	ORG $+3
$SG86465 DB	'header crc mismatch', 00H
$SG86482 DB	'invalid block type', 00H
	ORG $+1
$SG86486 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG86498 DB	'too many length or distance symbols', 00H
$SG86502 DB	'invalid code lengths set', 00H
	ORG $+3
$SG86512 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG86518 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG86521 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG86523 DB	'invalid literal/lengths set', 00H
$SG86525 DB	'invalid distances set', 00H
	ORG $+2
$SG86539 DB	'invalid literal/length code', 00H
$SG86550 DB	'invalid distance code', 00H
	ORG $+2
$SG86560 DB	'invalid distance too far back', 00H
	ORG $+2
$SG86573 DB	'incorrect data check', 00H
	ORG $+3
$SG86578 DB	'incorrect length check', 00H
	ORG $+1
$SG85852 DB	'1.2.8', 00H
_DATA	ENDS
PUBLIC	_inflate@8
...
; File f:\playground\assassin-playground\ctsvetkov\minh_nguyen\zlibcompression\zlib-1.2.8\inflate.c
_TEXT	SEGMENT
tv70 = -12						; size = 4
_next$ = -8						; size = 4
_got$ = -4						; size = 4
...
; 189  :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG85852[edx]
	cmp	eax, ecx
...
; 639  :         switch (state->mode) {
	...
	jmp	DWORD PTR $LN524@inflate[ecx*4]
$LN335@inflate:
...
; 662  :                 strm->msg = (char *)"incorrect header check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86406
...
; 667  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86408
...
; 675  :             else if (len > state->wbits) {
	...
	jbe	SHORT $LN344@inflate

; 676  :                 strm->msg = (char *)"invalid window size";

	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86412
...
; 691  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86416
...
; 696  :                 strm->msg = (char *)"unknown header flags set";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86418
...
; 800  :                     strm->msg = (char *)"header crc mismatch";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86465
...
; 859  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86482
...
; 868  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86486
...
; 929  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86502
...
; 952  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86512
...
; 975  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86518
...
; 989  :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG86521
...
; 1003 :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86523
...
; 1012 :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86525
...
; 1064 :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86539
...
; 1100 :                 strm->msg = (char *)"invalid distance code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86550
...
; 1130 :                         strm->msg = (char *)"invalid distance too far back";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86560
...
; 1189 :                     strm->msg = (char *)"incorrect data check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG86573
...
; 1202 :                     strm->msg = (char *)"incorrect length check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG86578
...
; 1232 :     if (state->wsize || (out != strm->avail_out && state->mode < BAD &&
	...
	jge	SHORT $LN499@inflate
	mov	eax, DWORD PTR _state$[ebp]
	cmp	DWORD PTR [eax], 26			; 0000001aH
	jl	SHORT $LN500@inflate
