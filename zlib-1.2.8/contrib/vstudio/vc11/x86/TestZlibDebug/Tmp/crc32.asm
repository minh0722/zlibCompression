; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24210.0 
	...
	TITLE	F:\playground\assassin-playground\ctsvetkov\minh_nguyen\zlibCompression\zlib-1.2.8\crc32.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File f:\playground\assassin-playground\ctsvetkov\minh_nguyen\zlibcompression\zlib-1.2.8\crc32.c
_TEXT	SEGMENT
_crc1$ = 8						; size = 4
_crc2$ = 12						; size = 4
_len2$ = 16						; size = 8
...
; 309  :         DOBIG4;
	...
	shr	esi, 8
	and	esi, 255				; 000000ffH
	mov	eax, DWORD PTR _crc_table[eax+ecx*4]
	xor	eax, DWORD PTR _crc_table[edx+esi*4]
	mov	ecx, 1024				; 00000400H
	imul	edx, ecx, 6
	mov	ecx, DWORD PTR _c$[ebp]
