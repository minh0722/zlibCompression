; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24210.0 
	...
	TITLE	F:\playground\assassin-playground\ctsvetkov\minh_nguyen\zlibCompression\zlib-1.2.8\deflate.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File f:\playground\assassin-playground\ctsvetkov\minh_nguyen\zlibcompression\zlib-1.2.8\deflate.c
_TEXT	SEGMENT
_len$ = -4						; size = 4
_strm$ = 8						; size = 4
_buf$ = 12						; size = 4
...
; 1608 :             FLUSH_BLOCK(s, 0);
	...
	mov	edx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [edx+92], 0
	jl	SHORT $LN21@deflate_st
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+56]
	mov	edx, DWORD PTR _s$[ebp]
	add	ecx, DWORD PTR [edx+92]
	mov	DWORD PTR tv162[ebp], ecx
	jmp	SHORT $LN22@deflate_st
$LN21@deflate_st:
...
; 1613 :         FLUSH_BLOCK(s, 1);
	...
	mov	ecx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [ecx+92], 0
	jl	SHORT $LN23@deflate_st
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+56]
	mov	ecx, DWORD PTR _s$[ebp]
	add	eax, DWORD PTR [ecx+92]
	mov	DWORD PTR tv185[ebp], eax
	jmp	SHORT $LN24@deflate_st
$LN23@deflate_st:
...
; 1616 :     if ((long)s->strstart > s->block_start)
	...
	jle	SHORT $LN16@deflate_st

; 1617 :         FLUSH_BLOCK(s, 0);

	mov	edx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [edx+92], 0
	jl	SHORT $LN25@deflate_st
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+56]
	mov	edx, DWORD PTR _s$[ebp]
	add	ecx, DWORD PTR [edx+92]
	mov	DWORD PTR tv209[ebp], ecx
	jmp	SHORT $LN26@deflate_st
$LN25@deflate_st:
