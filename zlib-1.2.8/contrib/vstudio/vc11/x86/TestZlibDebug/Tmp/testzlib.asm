; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24210.0 
	...
	TITLE	F:\playground\assassin-playground\ctsvetkov\minh_nguyen\zlibCompression\zlib-1.2.8\contrib\testzlib\testzlib.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG88822 DB	'rb', 00H
	ORG $+5
$SG88883 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG88886 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG88887 DB	'file %s read, %u bytes', 0aH, 00H
$SG88891 DB	'1.2.8', 00H
	ORG $+2
$SG88892 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG88893 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG88894 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG88895 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG88896 DB	'1.2.8', 00H
	ORG $+2
$SG88897 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG88898 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG88899 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG88900 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG88903 DB	'compare ok', 0aH, 00H
_DATA	ENDS
...
; File f:\playground\assassin-playground\ctsvetkov\minh_nguyen\zlibcompression\zlib-1.2.8\contrib\testzlib\testzlib.c
_TEXT	SEGMENT
_zcpr$1 = -260						; size = 56
_zcpr$2 = -204						; size = 56
