; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24210.0 
	...
	TITLE	F:\playground\assassin-playground\ctsvetkov\minh_nguyen\zlibCompression\zlib-1.2.8\trees.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File f:\playground\assassin-playground\ctsvetkov\minh_nguyen\zlibcompression\zlib-1.2.8\trees.c
_TEXT	SEGMENT
tv144 = -4						; size = 4
_s$ = 8							; size = 4
_buf$ = 12						; size = 4
...
; 589  :         next_code[bits] = code = (code + bl_count[bits-1]) << 1;
	...
	movzx	edx, WORD PTR _code$[ebp]
	mov	eax, DWORD PTR _bits$[ebp]
	mov	ecx, DWORD PTR _bl_count$[ebp]
	movzx	eax, WORD PTR [ecx+eax*2-2]
	add	edx, eax
	shl	edx, 1
	mov	WORD PTR _code$[ebp], dx
	mov	ecx, DWORD PTR _bits$[ebp]
